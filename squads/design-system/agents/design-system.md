...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to squads/super-agentes/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: audit-codebase.md → squads/super-agentes/tasks/audit-codebase.md
...
agent:
  ...
  customization: |
    ...
    *audit       → Read("squads/super-agentes/tasks/audit-codebase.md")
    *consolidate → Read("squads/super-agentes/tasks/consolidate-patterns.md")
    *tokenize    → Read("squads/super-agentes/tasks/extract-tokens.md")
    *migrate     → Read("squads/super-agentes/tasks/generate-migration-strategy.md")
    *build       → Read("squads/super-agentes/tasks/build-component.md")
    *compose     → Read("squads/super-agentes/tasks/compose-molecule.md")
    *extend      → Read("squads/super-agentes/tasks/extend-pattern.md")
    *setup       → Read("squads/super-agentes/tasks/setup-design-system.md")
    *document    → Read("squads/super-agentes/tasks/generate-documentation.md")
    *scan        → Read("squads/super-agentes/tasks/ds-scan-artifact.md")
    *design-compare → Read("squads/super-agentes/tasks/design-compare.md")
    *calculate-roi → Read("squads/super-agentes/tasks/calculate-roi.md")
    *shock-report → Read("squads/super-agentes/tasks/generate-shock-report.md")
    *upgrade-tailwind → Read("squads/super-agentes/tasks/tailwind-upgrade.md")
    *audit-tailwind-config → Read("squads/super-agentes/tasks/audit-tailwind-config.md")
    *export-dtcg → Read("squads/super-agentes/tasks/export-design-tokens-dtcg.md")
    *bootstrap-shadcn → Read("squads/super-agentes/tasks/bootstrap-shadcn-library.md")

    # DESIGN FIDELITY COMMANDS (Phase 7)
    *validate-tokens  → Read("squads/super-agentes/tasks/validate-design-fidelity.md")
    *contrast-check   → Read("squads/super-agentes/tasks/validate-design-fidelity.md") + focus: contrast
    *visual-spec      → Read("squads/super-agentes/templates/component-visual-spec-tmpl.md")

    # DS METRICS COMMANDS (Phase 8)
    *ds-health        → Read("squads/super-agentes/tasks/ds-health-metrics.md")
    *bundle-audit     → Read("squads/super-agentes/tasks/bundle-audit.md")
    *token-usage      → Read("squads/super-agentes/tasks/token-usage-analytics.md")
    *dead-code        → Read("squads/super-agentes/tasks/dead-code-detection.md")

    # READING EXPERIENCE COMMANDS (Phase 9)
    *reading-audit    → Read("squads/super-agentes/tasks/audit-reading-experience.md")
    *reading-guide    → Read("squads/super-agentes/data/high-retention-reading-guide.md")
    *reading-tokens   → Read("squads/super-agentes/templates/reading-design-tokens.css")
    *reading-checklist → Read("squads/super-agentes/checklists/reading-accessibility-checklist.md")

    # ACCESSIBILITY AUTOMATION COMMANDS (Phase 10)
    *a11y-audit       → Read("squads/super-agentes/tasks/a11y-audit.md")
    *contrast-matrix  → Read("squads/super-agentes/tasks/contrast-matrix.md")
    *focus-order      → Read("squads/super-agentes/tasks/focus-order-audit.md")
    *aria-audit       → Read("squads/super-agentes/tasks/aria-audit.md")

    # REFACTORING COMMANDS (Phase 6)
    *refactor-plan    → Read("squads/super-agentes/tasks/atomic-refactor-plan.md")
    *refactor-execute → Read("squads/super-agentes/tasks/atomic-refactor-execute.md")
